...
const takensTablePath = path.join(__dirname, "../public/database/tokens.json")
let users;
...
router.post('/', (req, res, next) => {
  ...
  dbHandler.checkJSONexistence(takensTablePath);
  fs.writeFileSync(takensTablePath, JSON.stringify({ token, expires, userId }))
